...
class Two_Fa extends Component {
	...
	/**
	 * Gradually move on to using the method is_enabled_otp_for_user(). Forminator uses it.
	 *
	 * @param int $user_id
	 *
	 * @return int
	...
	public function is_user_enabled_otp( $user_id ) {
		// Todo: it's not correct. Defender has other Auth methods since v2.8.0. So need to update this hook only for TOTP.
